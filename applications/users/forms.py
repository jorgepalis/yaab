...
from .models import User, CorreosCreditoGrupal, GrupoCreditoPersonal, RegistroCreditosModel
from applications.dashboard.models import ProductoCreditoGrupal, Prestamo, SimuladorPrueba
...
class AdminUserCreationForm(UserCreationForm):
    ...
    validate_email = forms.BooleanField(label='Validate Email', required=False)
...
class CorreoGrupoCredito(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['nombre_grupal', 'participantes_numero', 'monto_vacantes', 'correos_participantes', 'names_grupal',
                  'surnames_grupal', 'curp_texto_grupal', 'rfc_grupal', 'celular_coordinador', 'correo_coordinador']
...
class FormularioGRupoCreditoPersona(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['email', 'first_name', 'last_name', 'second_name', 'telefono_particular', 'fecha_nac_grupal', 'curp_texto', 'curp', 'documento_ine_grupal', 'comprobante_domicilio', 'rfc', 'estado_civil', 'genero', 'nacionalidad',
                  'pais', 'estado', 'celular', 'numero_dependientes', 'calle_numero', 'colonia', 'cp', 'ciudad', 'estado_direccion', 'tipo_vivienda', 'años_radicando', 'token', 'aviso_privacidad_grupal', 'buro_credito_grupal']

# *******************************


class RegistroCreditoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['usuarios', 'producto', 'fecha_credito']
...
class UploadExcelForm(forms.Form):
    ...
    excel_file = forms.FileField(
        label="Ingresa tu archivo de excel: ",
        required=True,
        widget=forms.ClearableFileInput(
            attrs={
                'class': 'form-control'
